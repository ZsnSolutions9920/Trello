...
export default function SettingsPage() {
  ...
  return (
    <div className="h-full flex flex-col bg-white">
      <Header backHref="/" />
      <main className="mx-auto w-full max-w-3xl flex-1 px-4 py-8 sm:px-10 sm:py-10 animate-fade-in-up">
              ...
              {user?.role === "admin" && (
                <div className="border-t border-border pt-4">
                  ...
                  <div className="flex flex-col gap-3 sm:flex-row sm:flex-wrap sm:items-center">
                    <code className="w-full overflow-x-auto rounded-xl border border-border bg-white px-4 py-2.5 font-mono text-base tracking-widest text-ink select-all sm:w-auto sm:text-lg">
                      {team.inviteCode}
                    </code>
                    <button
                      onClick={() => {
              ...
              <div className="border-t border-border pt-4">
                ...
                <div className="space-y-2">
                  {team.members.map((member) => (
                    <div key={member.id} className="flex flex-col gap-3 rounded-xl border border-border bg-white px-4 py-3 sm:flex-row sm:items-center sm:justify-between">
